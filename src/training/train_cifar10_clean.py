"""Training script for clean CIFAR-10 classification with 3-layer MLP."""
import argparse
import yaml
import torch
...
def main():
    parser = argparse.ArgumentParser(description='Train CIFAR-10 MLP on clean labels')
    parser.add_argument('--config', type=str, default='configs/experiment_config.yaml')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--output-dir', type=str, default='outputs/cifar10/clean')
