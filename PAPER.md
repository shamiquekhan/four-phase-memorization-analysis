...
|-------|----------------|--------------|
| Class separability (σ) at hidden layer | 0.693 [0.674, 0.712] | `src/utils/metrics.py:compute_sigma()`, `src/analysis/phase2_representation.py` |
...
| Corrupted test accuracy (20% noise) | 93.81% [92.58%, 95.04%] | `src/training/train_corrupted.py` |
...
|--------|------|----------|
| σ = within/between class distance | `src/analysis/phase1_basic.py` | `analyze_checkpoint()` |
...
| Scaling metrics (σ, mono, sparsity vs width) | `src/scaling/analyze_scaling.py` | `run_scaling_analysis()` |
...
| 8 | Scaling analysis (σ, mono, circuit, sparsity vs width) | `figure8_scaling_analysis()` |
