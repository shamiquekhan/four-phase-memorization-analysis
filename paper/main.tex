...
\begin{figure}[t]
  ...
  \caption{
    Scaling analysis across hidden dimensions 16--1024. Top-left: Davies-Bouldin index vs width. Top-right: Monosemanticity (fraction of neurons with $\rho>0.5$). Bottom-left: Mean circuit size (neurons/class). Bottom-right: Activation sparsity. Sparsity converges to 1.0 beyond $h=128$.
  }
  \label{fig:scaling}
\end{figure}
