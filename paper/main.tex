...
Corrupted models also show higher mean activations (0.08~$\to$~0.34) and lower sparsity (0.85~$\to$~0.82), recruiting more hidden neurons to represent the noise-inflated label space.
